...
DEPLOY_ENV=prod
DEPLOY_HOST=pploneconf2024-thomlamb.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for pploneconf2024-thomlamb.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    pploneconf2024-thomlamb.tangrama.com.br:
      ansible_user: root
      host: pploneconf2024-thomlamb
      hostname: pploneconf2024-thomlamb.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/pploneconf2024-thomlamb.tangrama.com.br.yml` to the remote server with:
